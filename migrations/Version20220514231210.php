 ...
 */
final class Version20220514231210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nivel_confianza (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ncn VARCHAR(255) NOT NULL, ncz VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE nivel_confianza');
        $this->addSql('DROP INDEX IDX_53AD8F834B89032C');
        $this->addSql('DROP INDEX IDX_53AD8F83F675F31B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__symfony_demo_comment AS SELECT id, post_id, author_id, content, published_at FROM symfony_demo_comment');
        $this->addSql('DROP TABLE symfony_demo_comment');
